...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval_batch_size', type=int, default=10, help='batch size during evaluation')
    parser.add_argument('--grad_accumulation_factor', type=int, default=10, help='number of gradient accumulation steps')
    parser.add_argument('--num_batches', type=int, default=100, help='number of batches for experiment; 1 batch = grad_accumulation_factor x batch_size')
    parser.add_argument('--eval_every', type=int, default=100, help='number of training batches per evaluation')
